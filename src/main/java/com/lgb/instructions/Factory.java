...
import com.lgb.instructions.references.monitor.MONITOR_ENTER;
import com.lgb.instructions.references.monitor.MONITOR_EXIT;
...
public class Factory {
    ...
    static {
        ...
        opcodeMap.put((byte) 0xc2, new MONITOR_ENTER());
        opcodeMap.put((byte) 0xc3, new MONITOR_EXIT());
